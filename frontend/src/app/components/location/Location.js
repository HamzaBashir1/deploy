          ...
          <ul className="flex whitespace-nowrap text-sm font-medium">
            <li className="me-2">
              <button
                ...
                className={`inline-block px-4 py-3 border rounded-lg ${
                  activeTab === "Favorite"
                    ? "text-[#58CAAA] border-[#58CAAA]"
                    : "text-[#667085] border-[#667085]"
                } bg-white hover:text-[#58CAAA] hover:border-[#58CAAA] focus:outline-none`}
              >
                Favorite
              </button>
            </li>
