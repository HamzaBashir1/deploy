...
const FeatureCard = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useFetchData(`${process.env.NEXT_PUBLIC_BASE_URL}/accommodation`);
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {accommodationData &&
            accommodationData.slice(0, 8).map((property) => {
              const ratingsInfo = ratingsData[property._id] || {
                averageRating: 0,
                ratingsCount: 0,
              };
                  ...
                  <div className="flex flex-col w-full max-w-xs overflow-hidden border rounded-lg sm:max-w-sm md:max-w-md lg:max-w-lg">
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      <p className="text-lg sm:text-sm text-[#666666]">
                        {property.person} persons, {property.bedroomCount}{" "}
                        bedrooms, {property.bathroomCount} bathrooms{" "}
                      </p>
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div className="flex gap-2">
                          ...
                          {property.equipmentAndServices.includes(
                            "Parking"
                          ) && <MdLocalParking />}
                          {property.equipmentAndServices.includes(
                            "Free Wifi"
