          ...
          <div className="hidden md:flex md:flex-row md:items-center md:gap-5">
            <div className="hidden gap-4 cursor-pointer md:flex md:flex-row md:items-center">
              ...
              <div className="flex items-center gap-2" onClick={toggleMenu}>
                ...
                <h1 className="text-[#292A34] text-sm">
                  {user?.name || "User"}
                </h1>
              </div>
            </div>
          ...
          {reviews.length > 0 ? (
            ...
            <div>
              ...
              <p className="max-w-xl text-gray-500">
                No one has rated your accommodation yet. Motivate your customers
                to evaluate, so you can see where your strengths are and what
                you can still improve. Good ratings also motivate new or
                undecided customers.
              </p>
            </div>
          )}
          ...
          <ul className="mt-4 space-y-2 font-medium text-gray-800">
            <li className="flex flex-row gap-2">
              ...
              <div className="flex flex-col">
                ...
                <p
                  className="text-xs"
                  onClick={() => updateSelectedpage("EditProfile")}
                >
                  Edit Profile
                </p>
              </div>
