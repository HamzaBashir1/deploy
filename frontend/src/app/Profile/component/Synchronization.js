...
console.log("book",bookings)
  ...
  return (
    <div>
      ...
      <div className="min-h-screen px-4 bg-white md:px-0">
        ...
        <div className="max-w-screen-md mx-auto">
          ...
          {selectedAccommodation && url && url !== "" && (
            <>
              ...
              <div className="flex flex-col gap-2 mb-5 md:flex-row md:gap-4">
                <button
        ...
        <div className="p-4">
          ...
          <ul className="mt-4 space-y-2 font-medium text-gray-800">
            <li className="flex flex-row gap-2">
              ...
              <div className="flex flex-col">
                <h1 className="text-[#292A34] text-sm">{user?.name || "User"}</h1>
                <p className="text-xs" onClick={() => updateSelectedpage("EditProfile")}>
                  Edit Profile
                </p>
              </div>
            </li>
