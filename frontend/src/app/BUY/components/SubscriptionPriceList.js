    ...
    <div>
     <div className="py-12">
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-2 mx-5 mb-10">
        <button className="border-gray-300 border-[2px] rounded-[10px]  px-4 py-2  shadow-sm focus:outline-none hover:bg-gray-100 text-[16px]">
          Cottages, wooden houses, log<br/>cabins
        </button>
        <button className=" border border-gray-300 px-4 py-2 rounded-lg shadow-sm focus:outline-none hover:bg-gray-100">
          Hotels, guesthouses
        </button>
      </div>
