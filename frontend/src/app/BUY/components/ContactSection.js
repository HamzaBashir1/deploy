...
function ContactSection() {
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-md lg:px-8 py-16 mx-8 bg-opacity-0">
          ...
          <div className="flex flex-col gap-4">
            {/* Buttons */}
            <button onClick={handleOpenModal} className="px-4 py-2 text-white transition duration-200 bg-[#4FBE9F] rounded hover:bg-green-600">
                  Write a message
            </button>
      ...
      {/* Modal Component */}
      {isModalOpen && <WriteMessage onClose={handleCloseModal} />}
    </div>
  )
}
