...
const NcInputNumber = ({
  ...
  // Update the value if the defaultValue prop changes
  useEffect(() => {
  ...
  const handleClickDecrement = () => {
    ...
    setValue((state) => {
      ...
      onChange && onChange(newValue); // Pass the updated value to the parent
      return newValue;
    });
  };
  ...
  // Render the label and description if provided
  const renderLabel = () => {
    return (
