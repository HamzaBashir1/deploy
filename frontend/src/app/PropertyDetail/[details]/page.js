    ...
    <div className="bg-[#F5F5F5]">
      ...
      <div className=" lg:px-10 xl:px-14 2xl:px-18 max-w-[1820px] mx-auto">
          ...
          <>
            ...
            >
              <div className="flex space-x-4">
                <button
                  onClick={() => router.back()}
                  className="flex items-center text-sm py-2 text-[#58CAAA]"
                >
                  <span className="mr-1">
                    <IoIosArrowBack />
                  </span>{" "}
                ...
                <button
                  onClick={() => scrollToSection("Overlook")}
                  className="px-4 py-2 text-sm "
                >
                  Don't Overlook
                </button>
              ...
              <div className="hidden md:flex items-center space-x-4">
                {favorite.includes(id) ? (
                  <BiSolidHeart className="text-xl sm:text-2xl text-[#DC2626] cursor-pointer hover:text-red-600" />
                ) : (
                  <BiHeart className="text-xl sm:text-2xl text-[#4FBE9F] cursor-pointer hover:text-red-500" />
                )}
                {/* Copy link functionality */}
                {isCopied ? (
                  <BiSolidCopy className="text-xl text-blue-500 cursor-pointer md:text-2xl" />
                ) : (
                  <BiCopy className="text-xl cursor-pointer md:text-2xl hover:text-blue-500" />
                )}
              </div>
            </div>
          </>
        ...
        <div className="flex justify-between py-1 md:hidden">
          ...
          <div className="">
            ...
            >
              ...
              />
              {showDot && (
                <circle cx={dotCoords.x} cy={dotCoords.y} r="15" fill="red" />
              )}
            </svg>
          </div>
        </div>
        ...
        <div className="flex ">
          ...
          <div
            className="hidden md:block w-[500px] h-[650px] sticky top-[40px] overflow-y-auto"
            id="card"
          >
            <Card
              data={accommodationData}
