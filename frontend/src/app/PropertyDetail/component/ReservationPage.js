...
const ReservationPage = ({
  ...
  <div style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5; color: #333; background-color: #f0f0f0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
      ...
      <ul style="list-style-type: none; padding: 0;">
        <li>Arriving with Children: ${
          reservation.withChildren ? "Yes" : "No"
        }</li>
  ...
  const handle_submit = async () => {
    ...
    try {
      ...
      toast.error(
        "There was an error sending your reservation. Please try again later."
      );
    }
  };
  ...
  const incrementInterestCount = async (id) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL}/accommodation/${accommodationId}/interest`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="flex flex-col gap-5 px-4 lg:flex-row sm:px-6 lg:px-40">
          <div className="flex-1 space-y-5">
            ...
            <div className="p-5 bg-white rounded shadow sm:p-10">
              <h1 className="text-base sm:text-lg">
                ...
                <span className="font-bold">
                  confirmed directly by the accommodation provider
                </span>
                . Prices, occupancy, and conditions are determined by the
            ...
            <div className="p-5 bg-white rounded shadow sm:p-10">
              ...
              <p>
                Notify the accommodation provider of additional information
                about your stay.
              </p>
              <hr className="my-3" />
            ...
            <div className="p-5 bg-white rounded shadow sm:p-10">
              ...
              <div className="flex items-start space-x-4">
                ...
                <h1>
                  The non-binding reservation will be sent directly to the
                  accommodation provider.
                </h1>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <h1>
                  The host will contact you using the provided information.
                </h1>
              </div>
              <div className="flex items-start space-x-4">
                <div className="p-2 bg-gray-300 rounded-full">3</div>
                <h1>
                  You will agree on final details with the accommodation
                  provider.
                </h1>
              </div>
            </div>
          ...
          <div className="flex-1 space-y-5  lg:mx-20">
            <div className="bg-white rounded shadow">
              <div className="flex items-start space-x-5 ">
                ...
                <div className="space-y-2">
                  ...
                  <h1 className="flex items-center">
                    ...
                    {Array.from(
                      { length: 5 - (data?.reviews?.length || 0) },
                      (_, index) => (
                  ...
                  <p>
                    {data?.propertyType}, {locationDetails?.city},{" "}
                    {locationDetails?.country}{" "}
                  </p>
                  <h1 className="flex items-center">
                    <GiTick /> Verified accommodation
                  </h1>
                </div>
              </div>
              ...
              <div className="p-5 space-y-5  sm:p-10">
                ...
                <div className="flex justify-between">
                  <h1>
                    {AccommodationName} ( {guests} persons / {nights} nights)
                  </h1>
                  <p>€{totalPrice}</p>
                </div>
                <hr />
                <p>
                  The displayed price is indicative and may vary depending on
                  the date and conditions of the reservation. The accommodation
                  provider will inform you of the exact price after sending the
                  non-binding reservation.
                </p>
              </div>
            </div>
