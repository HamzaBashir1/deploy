        ...
        <div className="pt-10 bg-[#F3F4F6]">
            ...
            <div className="flex flex-col items-start justify-between lg:flex-row lg:items-center">
              ...
              {/* </div> */}
                    ...
                    {isCopied ? (
                      <BiSolidCopy
                        className="text-xl cursor-pointer md:text-2xl sm:block hidden text-blue-500"
                        onClick={handleCopyLink}
                      />
                    ) : (
                      <BiCopy
                        className="text-xl sm:block hidden cursor-pointer md:text-2xl hover:text-blue-500"
                        onClick={handleCopyLink}
                      />
                    )}
