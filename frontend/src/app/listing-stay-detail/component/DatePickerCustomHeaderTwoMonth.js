  ...
  return (
    <div>
      ...
      <button
        ...
        className="absolute flex items-center justify-center p-2 rounded-full react-datepicker__navigation react-datepicker__navigation--next -top-1 -right-0 hover:bg-gray-100 dark:hover:bg-gray-700"
